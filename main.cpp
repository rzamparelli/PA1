...
//  consecutive.cpp
//
//  Created by Ross Zamparelli on 2/3/14.
...
{   
    ...
    while(1)
    {
        ...
        /// if user num2 - user num1 is equal to one then increment count
        if (num2 - num1 == 1)
            count++;
        else
            continue;
        ...
        if (cin.eof())
            break;
        /// if user num3 - user num2 is equal to one then increment count
        if (num3 - num2 == 1)
            count++;
        else
            continue;
